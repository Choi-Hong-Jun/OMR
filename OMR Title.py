...
class ExamInputWidget(QWidget):   # 시험 입력 화면
    ...
    def updateTable(self):   # 문제지 표 업데이트
        ...
        self.table_widget.resize(1140, 750)
        self.table_widget.move(400, 200)
...
class OMRGradingWidget(QWidget):    # OMR 채점 화면
    ...
    def initUI(self):
        ...
        self.cb.setGeometry(250, 20, 160, 50)
        ...
        self.table_widget.setGeometry(180, 60, 1500, 350)
                ...
                with open(file_name, "r", encoding='utf-8') as json_file:
                    ...
                    for question in questions:
                        if isinstance(question, dict):
                            real_answer = int(question.get("정답", 0))
